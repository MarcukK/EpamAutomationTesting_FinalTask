...
namespace PageObject
{
    public class Page
    {
        ...
        protected static int timeoutInSeconds = 15;
        ...
        public Page SwitchToNewWindow(FlightData testData)
        {
        ...
        public Page WaitForResults()
        {
            ...
            try
            {
                fluentWait.Until(x => x.FindElement(By.CssSelector(".IM_overlay_close_button.needsclick>img")).Displayed);
            ...
            {
                Logger.Log.Warn("Advertisment not found");
            }
            return this;
        }
